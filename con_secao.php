...
// Recupera o nome do formulario
    ...
    $id_ativo = isset($_POST["ativo"]) ? addslashes(trim($_POST["ativo"])) : FALSE;
    $id_inativo = isset($_POST["inativo"]) ? addslashes(trim($_POST["inativo"])) : FALSE;
   	if($id_ativo)
   	{if($id_inativo)
   		{$sql_ativo = "";}
   		else
...
//		  echo "<td><a href=pessoal.php?id=" .$dados["reg_ueb"] ."&amp;nome=". $dados["nome"] .">detalhe</a></td></tr>";
